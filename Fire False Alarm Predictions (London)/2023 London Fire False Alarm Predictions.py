...
#         return 'AFA'
#     elif 'false alarm' in row['IncidentGroup'].lower():
#         return 'Non-AFA'
#     elif 'special service' in row['IncidentGroup'].lower():
#         # Explicitly classify 'Special Service' incidents as 'Non-AFA'
#         return 'Non-AFA'
#     else:
#         # For actual fires without clear indication of the source, return 'Unknown'
#         return 'Unknown'
#     
